...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
##@Version           :  202409251014-git
# @@Author           :  Jason Hempstead
# @@Contact          :  jason@casjaysdev.pro
# @@License          :  LICENSE.md
# @@ReadME           :  install.sh --help
# @@Copyright        :  Copyright: (c) 2024 Jason Hempstead, Casjays Developments
# @@Created          :  Wednesday, Sep 25, 2024 10:14 EDT
# @@File             :  install.sh
...
CONTAINER_USER_NAME="root@$CONTAINER_DOMAINNAME"
...
CONTAINER_SECRET_KEY_NAME="TUDUDI_SESSION_SECRET"
