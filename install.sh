...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
##@Version           :  202410011653-git
# @@Author           :  Jason Hempstead
# @@Contact          :  jason@casjaysdev.pro
# @@License          :  LICENSE.md
# @@ReadME           :  install.sh --help
# @@Copyright        :  Copyright: (c) 2024 Jason Hempstead, Casjays Developments
# @@Created          :  Tuesday, Oct 01, 2024 16:53 EDT
# @@File             :  install.sh
# @@Description      :  Container installer script for tududi
...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
export APPNAME="tududi"
export VERSION="202410011653-git"
...
DOCKER_REGISTRY_REPO_NAME="tududi"
...
CONTAINER_WEB_SERVER_INT_PORT="9292"
...
CONTAINER_USER_NAME="$USER@$CONTAINER_HOSTNAME"
...
CONTAINER_ENV_USER_NAME="TUDUDI_USER_EMAIL"
CONTAINER_ENV_PASS_NAME="TUDUDI_USER_PASSWORD"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Set custom script - saves to /config/env/tududi.script.sh
...
if [ -n "$TUDUDI_USERNAME" ]; then
  CONTAINER_USER_NAME="$TUDUDI_USERNAME"
fi
if [ -n "$CONTAINER_USER_NAME" ]; then
  CONTAINER_USER_NAME="${TUDUDI_USERNAME:-${CONTAINER_USER_NAME:-$DEFAULT_USERNAME}}"
fi
if [ -n "$CONTAINER_USER_NAME" ]; then
...
if [ -n "$TUDUDI_PASSWORD" ]; then
  CONTAINER_USER_PASS="$TUDUDI_PASSWORD"
fi
if [ -n "$CONTAINER_USER_PASS" ]; then
  ...
  CONTAINER_USER_PASS="${TUDUDI_PASSWORD:-${CONTAINER_USER_PASS:-$DEFAULT_PASSWORD}}"
fi
if [ -n "$CONTAINER_USER_PASS" ]; then
